    ...
    <div v-for="(item, index) in commentList" class="hbl-child">
      ...
      <div class="content">
        ...
        <div class="reply-content">
          <i class="el-icon-delete" style="color: red;cursor:pointer;" v-show="item.showComment" @click="deleteContent(item.id)">删除评论</i>
        </div>
      ...
      <div class="children" v-for="(ritem, jndex) in item.childrenList">
        ...
        <div class="content">
          ...
          <div class="reply-content">
            ...
            <div>
              <i class="el-icon-delete" style="color: red;cursor:pointer;" v-show="ritem.showComment" @click="deleteContentChid(ritem.id, ritem.commentUser.id, item.id)">删除评论</i>
            </div>
          </div>
...
export default {
  ...
  methods: {
    ...
    doSend() {
      ...
      this.$set(this.buttonMap, 0, false);
    },
    ...
    deleteContentChid(index, commentUserId, pid){
      debugger;
      this.$emit("deleteContentChid", this.textareaMap[index], commentUserId, pid);
      console.log(index +";"+ commentUserId+";"+pid);
